...
For the (13) competitors, the results are exported from \texttt{SRBench} \url{https://cavalab.org/srbench/results/}, reported in~\cite{la2021contemporary}. 
...
\begin{figure}[!ht]
	...
	\begin{subfigure}[b]{0.75\textwidth} 
		\includegraphics[  width=300pt,height=180pt]{plots/Feynman_strogatz_noise_0_0-expanded.pdf}
		\caption{No noise}
	...
	\begin{subfigure}[b]{0.75\textwidth}
		...
		\includegraphics[  width=300pt,height=180pt]{plots/Feynman_strogatz_noise_0_001-expanded.pdf}
		\caption{Level of noise equal to 0.001}
		\label{fig:CDplots-noise0.001}
	\end{subfigure}
	
	\begin{subfigure}[b]{0.75\textwidth}
		\includegraphics[  width=300pt,height=180pt]{plots/Feynman_strogatz_noise_0_01-expanded.pdf}
		\caption{Level of noise equal to 0.01. }
