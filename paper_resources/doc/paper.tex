...
\begin{document}
   ...
   The progress in the SR field suffered from a lack of uniform, robust, and transparent
	...
	In this section we formally define the SR problem, followed by defining the search space framework of the problem. \fxnote{Marko: došao dovde sa ovom sekcijom}
