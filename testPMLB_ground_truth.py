...
ground_truth_regr_datasets = ['feynman_I_15_3x','feynman_test_7','feynman_test_6','feynman_II_11_27','feynman_test_17','feynman_III_10_19','feynman_I_9_18','feynman_I_32_17','feynman_test_20','feynman_test_12','feynman_I_29_16','feynman_test_11','feynman_II_13_23','feynman_test_1','feynman_II_13_34','feynman_I_15_3t','feynman_test_16','feynman_I_34_14','feynman_test_2','feynman_I_13_12','feynman_II_2_42','feynman_test_3','feynman_II_24_17','feynman_III_4_33','feynman_test_9','feynman_III_4_32','feynman_I_10_7','feynman_II_11_28','feynman_I_6_2a',]
...
for i in range(len(ground_truth_regr_datasets)):
    ...
    if parallelism==1:
        rils = RILSROLSRegressor(max_fit_calls=max_fit_calls, max_seconds=max_seconds, random_state = seed, complexity_penalty=complexity_penalty)
    elif parallelism>1:
        rils = RILSROLSEnsembleRegressor(max_fit_calls=max_fit_calls, max_seconds=max_seconds, random_state = seed, complexity_penalty=complexity_penalty, parallelism=parallelism)

    if noise_level!=0:
        rils.error_tolerance=noise_level
