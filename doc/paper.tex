...
\section{Introduction}\label{sec:introduction}
	...
	open-source, reproducible benchmarking platform for SR, called SRBench. The authors extended  PMLB~\cite{olson2017pmlb},  a repository of standardized regression by 130 SR datasets for which model forms are known, see more in the aforementioned paper.\fxnote{TODO: Describe results of experimental evaluation}
